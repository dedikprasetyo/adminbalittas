  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="navbar-header">
      ...
      <a href="#Welcome" class="navbar-brand halaman">
        <img src="assets/img/adminbalittas.png" width="290">
      </a>
    </div>   
        ...
        <form>
          ...
          <div class="modal-footer">
            <input type="button" class="btn btn-default" data-dismiss="modal" value="Batal">
             ...
             <?php echo anchor('crud/hapus/'.$jp->ID_JARAK_PAGAR,'<input type="button" class="btn btn-danger" value="Hapus">'); ?> 
...
<footer>
  <div class="container text-center">
    <figure>
      <img src="assets/img/adminbalittas.png" width=250 alt="Logo">
    </figure> <br>
    <div class="row">
