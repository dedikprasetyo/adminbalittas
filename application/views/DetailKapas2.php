					...
					<div class="row" style="margin-bottom: 20px;">
						<div class="col-xs-12 col-sm-12 col-lg-12">
								<div class="thumbnail" style=" border-radius: 5px; background-color: rgba(36,112,101,0.1);">
									...
									<br>
									<p><b>Catatan:</b></p>
									<p>Surat Keputusan Pelepasan <?php echo $value->nama_serat; ?> dapat diunduh <a href="" style="text-decoration-line: none"><b>di sini</b></a>.</p>
									<br>
									<br>
						...
						<div class="col-xs-12 col-sm-4 col-lg-4" > 
							<div class="thumbnail thumbku" style="box-shadow: 5px 5px 5px 0px rgba(0,0,0,0.2);">
								<a href="" style="text-decoration-line: none;">
									<img src="<?php echo base_url() ?>item img/Serat/Kapas.jpg" alt="" style="width: 100%;">
									<span class="label label-success"><p class="glyphicon glyphicon-calendar"></p> <?php echo $value->tanggal_upload; ?></span>
									<span class="label label-warning"><p class="glyphicon glyphicon-time"></p> <?php echo $value->waktu_upload; ?></span>	
									<h4 style="color:#fece00;"><?php echo $value->nama_varietas; ?></h4>
								</a>
								<br>							
								<div style="text-align: right; margin-bottom: 10px;margin-right: 10px;">
