...
SET @hitung = CONVERT((RIGHT((SELECT `id_jenis_leaflet` FROM `jenis_leaflet` ORDER by `id_jenis_leaflet` DESC LIMIT 1), 3)), UNSIGNED) + 1;
if (@hitung > 1) THEN
if (@hitung < 10) THEN 
...
INSERT INTO `varietas` (`id_serat`, `id_varietas`, `nama_varietas`, `tanggal_pelepasan`, `tanggal_upload`, `waktu_upload`, `file_SK`, `URLV`, `file_gambar`, `deskripsi_varietas`) VALUES
...
('S0002', 'V0023', 'Kanesia 18', '2014-07-18', '2018-07-26', '08:00:00', '', '', 'KANESIA 18.JPG', ''),
